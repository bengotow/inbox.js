describe('INThread', function() {
  ...
  describe('when unsynced', function() {
    it('should have resourcePath() like <baseUrl>/n/<namespaceId>/threads', function() {
      expect ((new INThread(inbox, null, 'fake_namespace_id')).resourcePath()).toBe('http://api.inboxapp.co/n/fake_namespace_id/threads');
    });
  });
